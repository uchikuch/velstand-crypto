...
export default function FooterMenu() {
  ...
  return (
    <>
      <div className="grid grid-cols-4 bg-white border-t-[1px]">
        <NavLink to="/dashboard">
          <div
            className={clsx(
              ...
              {
                "flex flex-col items-center justify-center text-sm border-t-4 border-t-green-800 border-x-2 border-x-gray-200 py-4 px-8 text-green-800":
                  "/dashboard" === location.pathname,
              }
            )}
          >
        ...
        <NavLink to="/dashboard/balance">
          <div
            className={clsx(
              ...
              {
                "flex flex-col items-center justify-center border-t-4 text-sm border-t-green-800 border-r-2 border-r-gray-200 py-4 px-8 text-green-800":
                  "/dashboard/balance" === location.pathname,
              }
            )}
          >
